...
class NotObstructs(Predicate):
    ...
    def __call__(self, **kwargs):
        ...
        resulting_env = ll_state.simulator.set_robot_active_dof_values_to_waypoint_values(ll_state,trajobj.GetWaypoint(waypoints_count-1))
        ...
        for name in colliding_object_names:
            ...
            if name != arg_map["obj"]:
                ...
                fail_strings.append("(obstructs {} {} {} {})".format(arg_map["trajectory"],name,arg_map["obj"],arg_map["table"]))
