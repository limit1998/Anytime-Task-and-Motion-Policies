...
DEFAULT_PROBLEM_FILE = DOMAIN_DIR+'Tasks/problem.pddl'  #  PATH to the PDDL/PPDDL problem file
DEFAULT_OUTPUT_FILE = DOMAIN_DIR+'Tasks/kitchen.output'  # Optional : PATH to the solution file
OPENRAVE_ENV_XML = DOMAIN_DIR+'Environments/new_env.dae' # Low level envrionment dae/xml path
ROBOT_NAME = 'fetch'  # NAME of the robot. Should match the robot name in the environment
DOMAIN_NAME = "kitcen"  # name of the domain. Optional
...
LOOPED_RUNS = False
BACKTRACK_PROB = 1.0
RESULTS_FILE = "result_kitchen.csv"