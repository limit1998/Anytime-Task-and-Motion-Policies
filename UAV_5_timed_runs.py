...
Config.DEFAULT_PDDL_FILE = Config.PROJ_DIR+'SampleTasks/hanger_5_domain.pddl'
Config.PORTNO = 1234
...
pickle.dump(times,open("uav_finalrun_times_"+str(Config.NUM_CANS)+"_5.p","wb"))
pickle.dump(seeds,open("uav_finalrun_seeds_"+str(Config.NUM_CANS)+"_5.p","wb"))
pickle.dump(success,open("uav_finalrun_success_"+str(Config.NUM_CANS)+"_5.p","wb"))
