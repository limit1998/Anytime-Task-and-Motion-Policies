from MotionPlanners import MotionPlannerBase
import random
import OpenraveUtils
import Config
from openravepy import *

class OpenRave_NativeMotion_Planner(MotionPlannerBase):
...
class OpenRave_OMPL_Base_Planner(OpenRave_NativeMotion_Planner):
    ...
    def get_ik_solutions_to_goal(self, goal_transform, do_check_collisions=True):
