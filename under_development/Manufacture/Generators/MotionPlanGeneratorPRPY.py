    ...
    def goal_param_generator(self):
        ...
        # If goal from generator is a pose, find IK solutions for pose.
            ...
            if IK_SOLVER == 'ik_fast':
                self.goal_configs = self.ll_state.simulator.get_ik_solutions(self.robot, self.goal_pose, check_collisions=True)
            elif IK_SOLVER == 'trac_ik':
                self.goal_configs = self.ll_state.simulator.get_trac_ik_solutions(self.robot, self.goal_pose, check_collisions=True)
        else:
