...
class FetchConfig(object):
    def __init__(self):
        ...
        self.armTuckDOFs = [0,0,0,0.00000000e+00, 1.71996798e+00, 2.70622649e-06,
...
class FetchOpenRaveRobotModel:
    ...
    def mapPhysicalRobotJointValues(self):
        pass
        # fjl = FetchJointListener()
        # joints = fjl.joints
        # jointIndexes = []
        # jointValues = []
        # for joint_name in joints:
        #     jointIndexes.append(self.robot.GetJointIndex(joint_name))
        #     jointValues.append(joints[joint_name])
        # self.robot.SetJointValues(jointValues, jointIndexes)
        import pickle
        joint_dump = open(Config.PROJ_DIR+"/real_world_exec/init_joint_state.pickle","rb")
...
class YuMiConfig(object):
    def __init__(self):
        self.jointnames = (["yumi_joint_1_l", "yumi_joint_2_l", "yumi_joint_7_l", "yumi_joint_3_l", "yumi_joint_4_l",
...
class YuMiOpenRaveRobotModel:
    def __init__(self, environment, doMapJoints=True):
        ...
        yumi_urdf = Config.FETCH_URDF
        yumi_srdf = Config.FETCH_SRDF
