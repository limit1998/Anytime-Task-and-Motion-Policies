...
from TaskPlannerInterface.TaskPlannerOutputParser import TaskPlannerOutputParser
import Config as Config
from Planner import Planner
from Parser.PDDLPlanParser import PDDLPlanParser
import networkx as nx
from Solution.FFSolution import FFSolution
...
class FFPlanner(Planner):
    ...
    def __runPlanner(self, domain_file, problem_file, output_file):
        commandStr = Config.FastForwardExe + " -o " + domain_file + " -f " + problem_file
