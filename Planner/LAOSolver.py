...
from Solution.LAOSolution import LAOSolution
...
class LAOSolver(Planner):
    ...
    def __runPlanner(self,domain_file="canworld_mdp.pddl",problem_file = "p01",output_file = None):
        ...
        while True:
            killed = False
            p1 = subprocess.Popen([Config.HOME_DIR+"mdp-lib/testppddl.out",dom_prob_file_path,"p01",str(Config.HORIZON),Config.POLICY_OUTPUT_FILE])
