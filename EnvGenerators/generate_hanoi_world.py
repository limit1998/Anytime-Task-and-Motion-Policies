...
def execute(num_objects, box_dims=(0.05,0.05,0.05), max_radial_distance=0.73, robot_dist_from_table=0.15, seed=int(time.time()), envFile=settings.envFile, tabletype='rll', viewer=False):
