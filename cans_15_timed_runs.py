...
Config.PLOT = True
Config.NUM_CANS = 15
Config.RESULTS_FILE = "results_"+str(Config.NUM_CANS)+"_cans_10.csv"
...
Config.PORTNO = 1234
Config.POLICY_OUTPUT_FILE = Config.PROJ_DIR + "graph1.gv"
Config.COMBINED_FILE = Config.PROJ_DIR + "combined_file1.pddl"
...
seeds = []
success = []
Config.RESULTS_FILE = "results_"+str(Config.NUM_CANS)+"_cans_50.csv"
...
Config.RESULTS_FILE = "results_"+str(Config.NUM_CANS)+"_cans_90.csv"
