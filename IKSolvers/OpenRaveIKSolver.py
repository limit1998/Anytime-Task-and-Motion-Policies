...
class OpenRaveIKSolver(object):
    ...
    def get_ik_solutions(self, end_effector_transform, do_check_collisions=True):
    ...
    def get_ik_solutions_to_obj(self, end_effector_transform, do_check_collisions=True):
